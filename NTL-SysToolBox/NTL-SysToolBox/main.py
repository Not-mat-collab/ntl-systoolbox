...
CONFIG_FILE = Path("src/ntl_config.json")
...
class MainCLI:
    ...
    def main_menu(self):
        while True:
            ...
            print("  [3] Module 3 - Audit Obsolescence")
            ...
            if choice == "0":
                ...
                subprocess.run([sys.executable, "src/module1_diagnostic.py", "--menu"])
            elif choice == "2":
                # Module2 avec config
                self._run_module2()
            elif choice == "3":
                # Lance menu Module3 autonome
                subprocess.run([sys.executable, "src/module3_audit.py"])
            else:
                print("\n[!] Option invalide.")
                input("Entrée...")
    ...
    def _run_module2(self):
        ...
        if input("\nLancer? (o/n) [o]: ").strip().lower() != "n":
            ...
            result = subprocess.run([sys.executable, "src/module2_wms_backup.py"], 
